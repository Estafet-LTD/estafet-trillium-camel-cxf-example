...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
                ...
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://webservices.globaladdress.net"
    ...
    <tns:ProcessAddressesResponseEBM>
      <tns:DataArea>
        <tns:ProcessAddressesResponse>
          <tns:Result>
            <xsl:value-of select="/soapenv:Envelope/soapenv:Body/ns0:ProcessMultipleAddressesV2010Q2Response/ns0:ProcessMultipleAddressesV2010Q2Result"/>
          </tns:Result>
          <xsl:for-each select="/soapenv:Envelope/soapenv:Body/ns0:ProcessMultipleAddressesV2010Q2Response/ns0:tmpContacts/ns0:Contact">
