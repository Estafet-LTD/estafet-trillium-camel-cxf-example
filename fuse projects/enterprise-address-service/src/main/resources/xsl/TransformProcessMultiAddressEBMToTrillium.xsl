			...
			<soapenv:Body>
				<tns:ProcessMultipleAddressesV2010Q2>
					...
					<xsl:variable name="Quality"
						select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:AddressPostal[1]/ebo:Quality" />
					<xsl:choose>
					...
					<xsl:variable name="Match"
						select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:AddressPostal[1]/ebo:Match" />
					<xsl:choose>
					...
					<xsl:if
						test="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:EnhancementDatasetName">
						<tns:EnhancementDatasetName>
							<xsl:value-of
								select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:EnhancementDatasetName" />
						</tns:EnhancementDatasetName>
					</xsl:if>


					<xsl:if
						test="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options">
						<tns:Options>
							<xsl:if
								test="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsMain">
								<tns:Options>
									<xsl:for-each
										select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsMain/ebo:COptimaOption">
										<tns:COptimaOption>
											<xsl:if test="@xsi:nil">
                      ...
                      <xsl:value-of select="@xsi:nil" />
							...
							<xsl:if
								test="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsMask">
								<tns:OptionMasks>
									<xsl:for-each
										select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsMask/ebo:COptimaOptionMasks">
                      ...
                      <xsl:value-of select="@xsi:nil" />
							...
							<xsl:if
								test="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsOther">
								<tns:OptionsOther>
									<xsl:for-each
										select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddress/ns0:Options/ebo:OptionsOther/ebo:COptimaOptionOther">
					...
					<tns:tmpContacts>
						<xsl:for-each
							select="/soapenv:Envelope/soapenv:Body/ns0:ProcessAddressesEBM/ns0:DataArea/ns0:ProcessAddresses/ns0:AddressPostal">
							<tns:Contact>
